...
const GOVUKExperience = () => (
  <Li>
    Rebuild GOV.UK formats as part of the <MigrationProgramme /> team, moving from the legacy monolith publisher to a{' '}
    <B>microservices</B> pipeline. <B>Ruby on Rails</B>
    , <B>TDD</B>, <B>Agile</B>.
  </Li>
)
const WebchatAlpha = () => (
...
const SuggestionEngine = () => (
  <a href="https://github.com/alphagov/openregister-picker-engine" target="_blank">
    suggestion engine
  </a>
)
const GenerateCountryPickerData = () => (
  <a href="https://github.com/openregister/generate-picker-data-file" target="_blank">
...
const GDS = () => (
  <section>
    ...
    <Ul>
      <Li>
        Lead development of a <CountryPicker />. Talk to service teams to learn about their needs, prototype initial
        implementation, build an <AccessibleAutocomplete /> and a <SuggestionEngine />. Take the component to user
        research, with abled users and with users with access needs, and to an accessibility audit from the <DAC />.{' '}
        <B>Preact.js</B>, <B>TDD</B>, <B>Selenium testing</B>, <B>accessibility testing</B>
      ...
      <Li>
        Sole developer on the <WebchatAlpha /> project, building user research prototypes and testing with users. Focus
        on <B>accessibility</B> of webchat interfaces. Attend user research sessions, conduct on-site interviews with
        departments using webchat. Released findings as presentations, <WebchatBlogPost />
      ...
      <GOVUKExperience />
      <Li>
        Present talks about <B>React.js</B> and <B>accessibility</B>. Provide mentoring to apprentices, line manage 2
        developers.
      </Li>
    </Ul>
  </section>
...
const Timecounts = () => (
  <section>
    ...
    <Ul>
      ...
      <Li>
        Help the team refine their <B>Agile</B> processes, implement code review and issue tracking methods. Champion{' '}
        <B>functional programming</B> and linting.
      </Li>
    </Ul>
  </section>
)
...
const Workangel = () => (
  <section>
    ...
    <Ul>
      <Li>
        Build product features on the admin panel and user facing application, two single page applications that
        interact with a <B>RESTful JSON API</B>. <B>Node.js</B>, <B>Angular.js 1.x</B>
        , <B>Stylus</B>.
      </Li>
      <Li>
        Ship a <B>mobile-first design</B> rebuild and <B>animations</B> for inter-page transitions and more, both not
        scoped or factored into estimations but delivered to extremely favourable reception.
      </Li>
      <Li>
        Dramatically improve the build process by <B>optimising the performance</B> of tasks and embracing modern best
        practices: template minification, linting, unit and Selenium integration testing, continuous integration, load
        testing.
      </Li>
      <Li>Defined Jade, Stylus, and JavaScript styleguides. Provided mentoring and coaching to new developers.</Li>
    </Ul>
  </section>
)
...
const ReadForward = () => (
  <section>
    ...
    <Ul>
      <Li>
        Lead development of an open source <LFA />. Build the pipeline and the frontend pattern library. Onboard and
        train junior developers in its use that produced our digital textbook offerings for primary education, which
        became the company's bread and butter product. <B>Node.js</B>, <B>Backbone.js</B>
        , <B>pattern libraries</B>, <B>visual regression testing</B>.
      </Li>
      <Li>
        Architected and managed a <DeltaApp />. Delivered 1.0 in just <B>3 weeks</B> of development time.{' '}
        <B>Ampersand.js</B>, <B>Famous.js</B> native-like animations, <B>Cordova</B>, <B>testing</B>
      ...
      <Li>
        ...
        relationships between models. Build a <B>RESTful JSON API</B> for the newly developed native mobile apps.
        Website was deployed at scale with hundreds of thousands of hits per month. <B>Ruby on Rails</B>
  ...
  <Layout wide>
    <article>
      ...
      <section>
        ...
        <p>
          Please peruse my <GitHub /> for nearly all of my side projects. Notable highlights:
        </p>
        <Ul>
          <Li>
          ...
          <Li>
            the source code for my <B>Next.js</B> and <B>React.js</B> <Vararuorg />;
          </Li>
          <Li>
      ...
      <section>
        ...
        <p>
          I admin my own DigitalOcean server, but also deploy to <B>Heroku</B>, <B>AWS Lambda</B>, static websites, and
          other solutions depending on the need.
        </p>
      </section>
